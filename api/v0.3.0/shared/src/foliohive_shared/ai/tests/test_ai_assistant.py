...
class TestProcessQueryWithBundle:
    """Test summarize_query_html method."""
    ...
    def test_empty_bundle_returns_no_repos_response(self):
        ...
        result = assistant.summarize_query_html("test query", bundle_context)
    ...
    def test_successful_bundle_processing(self, mock_openai_class):
        ...
        result = assistant.summarize_query_html("What languages?", bundle_context)
...
class TestModelTierSelection:
    ...
    def test_summarize_query_html_accepts_model_tier(self, mock_openai_class):
        ...
        result = assistant.summarize_query_html("query", bundle_context, model_tier="balanced")
