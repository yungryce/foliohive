...
class TestGitHubAPIMakeRequest:
    ...
    @responses.activate
    def test_make_request_404_returns_body(self):
        """Test that 404 responses return the response body."""
        responses.add(
            responses.GET,
    ...
    @responses.activate
    def test_make_request_error_returns_body(self):
        """Test that error responses return the response body."""
        responses.add(
            responses.GET,
            'https://api.github.com/repos/testuser/test-repo',
    ...
    def test_make_request_rate_limit(self):
        ...
        api = GitHubAPI(token='test_token', username=DEFAULT_USERNAME)
        result = api.make_request('GET', '/users/testuser')
        assert isinstance(result, dict)
...
@pytest.mark.parametrize("status_code", [200, 201, 404, 401, 403])
def test_make_request_status_code_handling(status_code):
    """Parametrized test: 2xx and 4xx status codes all return a dict body."""
