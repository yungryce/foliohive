...
class TestConfigExtractionRegistry:
    ...
    def test_extractor_dispatcher_routes_by_filename(self):
        ...
        # NOTE: The actual extractor returns a list of dependency names, not a dict
        # This test assumption needs to be updated based on actual extractor behavior
...
class TestPythonExtractors:
    ...
    def test_extract_requirements_txt(self):
        ...
        assert result is not None
        # NOTE: Extractor returns list of package names, not full version specs
...
""".strip()
        ...
        assert result is not None
        # NOTE: Extractor returns lists of package names, not full specs
...
""".strip()
        ...
        assert result is not None
        # NOTE: Extractor returns lists of dependency names, not nested dicts
