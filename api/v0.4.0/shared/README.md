# foliohive Shared Package (v0.4.0)

Shared Python utilities for foliohive services.

The package lives under `api/v0.4.0/shared/` and is imported by Function Apps and other backend components as `foliohive_shared`.
...
Backend tests (unit + integration) are centralized under `api/v0.4.0/tests/`:
